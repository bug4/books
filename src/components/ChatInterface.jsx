...
const ChatInterface = ({ currentAgent }) => {
 ...
 return (
   <div className="absolute left-8 top-1/2 -translate-y-1/2 w-80 h-[600px] bg-black/30 backdrop-blur-md border border-purple-500/30">
     {/* Header */}
     <div className="absolute top-0 left-0 right-0 border-b border-purple-500/30 bg-purple-900/20 p-3">
     ...
     {/* Messages */}
     <div className="absolute top-[60px] bottom-[60px] left-0 right-0 overflow-y-auto p-4 space-y-4">
     ...
     {/* Input */}
     <div className="absolute bottom-0 left-0 right-0 border-t border-purple-500/30 p-3 bg-black/30">
